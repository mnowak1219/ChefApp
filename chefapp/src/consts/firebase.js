export const URL = 'https://chefapp-80795-default-rtdb.europe-west1.firebasedatabase.app/'
export const API_KEY = 'AIzaSyB4R8OezqrVQsVCJC1a3usLoaprufanIZM'
...
export const DELETE_ACCOUNT_URL = 'https://identitytoolkit.googleapis.com/v1/accounts:delete?key=' + API_KEY
export const GET_USER_EMAIL_URL = 'https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=' + API_KEY